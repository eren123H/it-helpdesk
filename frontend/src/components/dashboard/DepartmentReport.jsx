...
const s = {
  ...
  title: { fontSize: '1.4rem', fontWeight: 700, color: '#e6edf3', margin: 0 },
  subtitle: { fontSize: '.85rem', color: '#8b949e', marginTop: 4 },
  grid3: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16, marginBottom: 24 },
  statCard: { 
    background: 'rgba(255, 255, 255, 0.03)', backdropFilter: 'blur(16px)', border: '1px solid rgba(255, 255, 255, 0.1)', 
    borderRadius: 16, padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center'
  },
  iconWrapper: { marginBottom: 12, padding: 12, background: 'rgba(255, 255, 255, 0.05)', borderRadius: 12 },
  statValue: { fontSize: '2rem', fontWeight: 800, color: '#e6edf3', lineHeight: 1 },
  statLabel: { fontSize: '.8rem', color: '#8b949e', marginTop: 8, textTransform: 'uppercase', letterSpacing: '.05em' },
  layout: { display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 24, alignItems: 'start' },
  card: { background: 'rgba(255, 255, 255, 0.03)', backdropFilter: 'blur(16px)', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: 16, padding: 24 },
  cardTitle: { fontSize: '1.1rem', fontWeight: 600, color: '#e6edf3', marginTop: 0, marginBottom: 20, display: 'flex', alignItems: 'center', gap: 8 },
  tableWrap: { overflowX: 'auto' },
  table: { width: '100%', borderCollapse: 'collapse' },
  th: { textAlign: 'left', padding: '12px 16px', fontSize: '.75rem', textTransform: 'uppercase', color: '#8b949e', borderBottom: '1px solid #30363d' },
  tr: { borderBottom: '1px solid rgba(255, 255, 255, 0.05)' },
  td: { padding: '16px', fontSize: '.85rem', color: '#c9d1d9' },
  deptName: { fontWeight: 600, color: '#4f8ef7', background: 'rgba(79,142,247,0.1)', padding: '4px 10px', borderRadius: 6 },
  catList: { display: 'flex', flexDirection: 'column', gap: 16 },
  catItem: { display: 'flex', flexDirection: 'column' },
  barBg: { height: 6, background: '#161b22', borderRadius: 3, overflow: 'hidden' },
  barFill: { height: '100%', background: 'linear-gradient(90deg, #4f8ef7, #7c5af5)', borderRadius: 3 },
};
